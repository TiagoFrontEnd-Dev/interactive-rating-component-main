...
![Prévia de design para o desafio de codificação do componente de classificação interativo](./design/desktop-preview.jpg)
...
Seu desafio é criar este componente de classificação interativo e fazê-lo parecer o mais próximo possível do design.
...
Quer suporte para o desafio? [Junte-se à nossa comunidade](https://www.frontendmentor.io/community) e faça perguntas no canal **#help**.
...
Se você quiser os arquivos de design (nós fornecemos versões Sketch e Figma) para inspecionar o design em mais detalhes, você pode [inscrever-se como um membro PRO](https://www.frontendmentor.io/pro).
...
2. Tweete [@frontendmentor](https://twitter.com/frontendmentor) e mencione **@frontendmentor**, incluindo o repositório e URLs ativos no tweet. Adoraríamos dar uma olhada no que você construiu e ajudar a compartilhar.
...
Fornecemos modelos para ajudar você a compartilhar sua solução depois de enviá-la para a plataforma. Edite-os e inclua perguntas específicas quando estiver buscando feedback.
...
Este desafio é totalmente gratuito. Compartilhe com qualquer pessoa que o considere útil para praticar.
